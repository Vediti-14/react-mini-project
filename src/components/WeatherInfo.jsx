      ...
      <Card sx={{ maxWidth: 345 }}>
        ...
        <CardContent>
          ...
          <Typography gutterBottom variant="subtitle1" component="div" className="city-name">
            <p>
             <h3>Todays Weather is like</h3><i>{info?.weather[0]?.description}</i> and it feels like {info?.main?.feels_like}&deg;C.
            </p>
          </Typography>
          <Typography variant="body2" color="blue" component={"span"}>
            <ul>
            <li>Temperature: {info?.main?.temp}&deg;C</li>
            <li>Minimum Temperature: {info?.main?.temp_min}&deg;C</li>
            <li>Maximum Temperature: {info?.main?.temp_max}&deg;C</li>
            <li>Humidiy: {info?.main?.humidity}</li></ul>
          </Typography>
        </CardContent>
      </Card>
    </div>
